<?php 
  ...
  function _themename_site_logo_args($args, $defaults) {
    $args['single_wrap'] = '<div class="%1$s faux-heading"><h1>%2$s</h1></div>';
    return $args;
  }
	add_filter( 'twentytwenty_site_logo_args', '_themename_site_logo_args', 10, 2 );
  ...
  // function _themename_site_description($html, $args, $classname, $contents) {
  //   if ( get_theme_mod( 'hide_site_title', true ) ) {
  //     return '';
  //   }
  ...
  // add_filter( 'twentytwenty_site_logo', '_themename_site_description', 20, 4 );
  ...
  //     // get desktop meta
  //     $desktop = get_post_meta( $post_id, '_themename_sidebar_plugin_desktop_title_visible', true );
  //     if($desktop) {
  //       $classes[] = 'hide-title-desktop';
  //     }
  //     // get mobile meta
  //     $mobile = get_post_meta( $post_id, '_themename_sidebar_plugin_mobile_title_visible', true );
  //     if($mobile) {
